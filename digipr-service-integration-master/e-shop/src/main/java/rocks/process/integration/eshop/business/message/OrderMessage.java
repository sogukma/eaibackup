...
public class OrderMessage {
    ...
    public OrderMessage(String orderId, String customerId, Double amount, Integer numberOfItems, List<OrderItem> items, String transactionId, String trackingId, String packingSlipId, String status, Integer stockAmount) {
