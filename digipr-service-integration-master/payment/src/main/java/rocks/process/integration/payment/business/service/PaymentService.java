...
public class PaymentService {
    ...
    public Transaction processPayment(Long customerId, String orderId, Amount amount, Integer numberOfItems, String cardTranactionId) throws Exception {
       ...
       System.out.println("dieser customer: " + customer.getCustomerId()+" "+ customer.getBirthdate());
        Transaction transaction = new Transaction(customer.getCustomerId(), orderId, amount, numberOfItems, cardTranactionId);
